...
export default function VideosPage() {
  ...
  useEffect(() => {
    ...
    if (stored) {
      try {
        ...
        const published = allVideos.filter((v: Video) => v.published);
        setVideos(published);
      } catch (e) {
  ...
  return (
    <PublicLayout settings={firmSettings}>
          ...
          <AnimatedSection animation="fade">
            <div className="max-w-4xl mx-auto text-center">
              <div className="inline-block mb-6 px-6 py-2 bg-blue-500/20 backdrop-blur-sm rounded-full border border-blue-400/30">
                <span className="text-blue-300 font-semibold">Video Library</span>
              </div>
              ...
              <p className="text-xl text-blue-100 leading-relaxed">
                Watch our video content and educational resources on legal topics
              </p>
            </div>
          </AnimatedSection>
        </div>
      ...
      {/* Videos Grid with Black Texture Background */}
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
              {videos.map((video, index) => (
                ...
                >
                  <ContentCard
                    title={video.title}
                    excerpt={video.description || 'Watch this video'}
            ...
            <AnimatedSection animation="fade">
              <div className="text-center py-16 bg-gradient-to-br from-gray-900/50 to-blue-900/30 backdrop-blur-sm rounded-2xl border border-blue-500/20 max-w-2xl mx-auto">
                ...
                <p className="text-blue-200">Check back soon for video content from our firm.</p>
              </div>
            </AnimatedSection>
          )}
        </div>
